...
static char *camera_fixup_setparams(int id, const char *settings)
{
    ...
    if (params.get("scene-mode")) {
        ...
        if (!strcmp(sceneMode, "hdr")) {
            // On Motorola msm8226, HDR works by setting 'ae-bracket-hdr' to 'HDR' ('AE-Bracket' exists too).
            // We then use 'auto' scene mode as it's AOSP/Nexus behavior
