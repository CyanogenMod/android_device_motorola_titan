...
extern int get_data_a(void *buf, int n);
...
extern int get_data_g(void *buf, int n);
...
extern int get_data_m(void *buf, int n);
...
extern int get_data_o(void *buf, int n);
...
extern int get_data_vg(void *buf, int n);
...
extern int get_data_vla(void *buf, int n);
...
extern int get_data_vrv(void *buf, int n);
